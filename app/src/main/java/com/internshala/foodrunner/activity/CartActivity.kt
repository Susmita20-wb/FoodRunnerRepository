...
class CartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var sharedPreference=getSharedPreferences(sessionManager.PREF_NAME, Context.MODE_PRIVATE)
        ...
        if(intent!=null){
            ...
            finish()
            Toast.makeText(this@CartActivity,"Some unexpected error occured!",Toast.LENGTH_SHORT).show()
        }
        if(resId=="0"){
            finish()
            Toast.makeText(this@CartActivity,"Some unexpected error occured!",Toast.LENGTH_SHORT).show()
